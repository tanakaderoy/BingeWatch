...
class TvShowResult: Codable {
    ...
    init(originalName: String, id: Int, name: String, voteCount: Int, voteAverage: Double, firstAirDate: String, posterPath: String, genreIDS: [Int], backdropPath: String, overview: String, popularity: Double, mediaType: MediaType) {
